...
model.fit(new_train_X, new_train_Y, epochs=100, batch_size=32, validation_split=0.05)
...
print('ARIMA Test MSE: %.3f' % mse_test_arima)
print('ARIMA Test MAE: %.3f' % mae_test_arima)
...
plt.ylabel('Visits')
plt.legend()
plt.title('Visits predictions - ARIMA-ANN model')
plt.show()
